...
# Configuration Script – DSBC-101 serial - Rev. A

This **Configuration** script is designed for the **DSBC-101 serial** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – DSBC-101 serial Rev. A

Este script de **Configuration** está diseñado para el modelo **DSBC-101 serial** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
